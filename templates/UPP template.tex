...
% Bacteria
\DescSet{Acinetobacter baumannii}{}
\DescSet{Citrobacter freundii}{}
\DescSet{Enterococcus faecalis}{}
\DescSet{Enterococcus faecium}{}
\DescSet{Enterobacter cloacae}{}
\DescSet{Enterobacter aerogenes}{}
\DescSet{Escherichia coli}{}
\DescSet{Klebsiella pneumoniae}{}
\DescSet{Proteus mirabilis}{}
\DescSet{Proteus vulgaris}{}
\DescSet{Pseudomonas aeruginosa}{}
\DescSet{Staphylococcus aureus}{}
\DescSet{Staphylococcus saprophyticus}{}
\DescSet{Strep B/ S. agalactiae}{}
\DescSet{Ureaplasma urealyticum}{}
...
\begin{tabularx}{\textwidth}{@{}%
    ...
    \begin{minipage}{\linewidth}
        ...
        {\fontsize{16}{22}\selectfont UPP \large{(Urine Pathogen Profile)} \fontsize{16}{22}\selectfont Test}
    \end{minipage}
    &
...
% Command to check if a value is in range (0, 35)
\newcommand{\inrange}[1]{%
  \fpeval{((\Val{#1}) > 0) && ((\Val{#1}) < 35) ? 1 : 0}%
}

% Command to check if ALL 18 pathogens are out of range
% Returns 1 if all are out of range (nothing detected), 0 if at least one is in range
\newcommand{\allPathogensOutOfRange}{%
  \fpeval{
    (\inrange{Acinetobacter baumannii} == 0) &&
    (\inrange{Citrobacter freundii} == 0) &&
    (\inrange{Enterococcus faecalis} == 0) &&
    (\inrange{Enterococcus faecium} == 0) &&
    (\inrange{Enterobacter cloacae} == 0) &&
    (\inrange{Enterobacter aerogenes} == 0) &&
    (\inrange{Escherichia coli} == 0) &&
    (\inrange{Klebsiella pneumoniae} == 0) &&
    (\inrange{Proteus mirabilis} == 0) &&
    (\inrange{Proteus vulgaris} == 0) &&
    (\inrange{Pseudomonas aeruginosa} == 0) &&
    (\inrange{Staphylococcus aureus} == 0) &&
    (\inrange{Staphylococcus saprophyticus} == 0) &&
    (\inrange{Strep B/ S. agalactiae} == 0) &&
    (\inrange{Ureaplasma urealyticum} == 0) &&
    (\inrange{Candida albicans} == 0) &&
    (\inrange{Candida auris} == 0) &&
    (\inrange{Candida glabrata} == 0)
    ? 1 : 0
  }%
}

% Store the result
\ValSet{noPathogenDetected}{\allPathogensOutOfRange}
...
\begin{tabularx}{\textwidth}{
  >{\hspace{2em}\raggedright\arraybackslash}X
...
\normalfont\textbf{Detected Pathogen(s)} & 
\multicolumn{3}{l}{\normalfont\textbf{Pathogen level} \footnotesize{ 0.1 (low) $\rightarrow$ 25 (high)}} \\
% \arrayrulecolor{lighterbar}\specialrule{0.7pt}{0pt}{0pt}\arrayrulecolor{black}
\hline

% \Val{noPathogenDetected} & & \\

% Check if no pathogens detected
\ifnum\Val{noPathogenDetected}=1
  % \multicolumn{4}{l}{No Pathogen Detected} \\
  \textit{No Pathogen Detected. } \\
\else
  % Show only detected pathogens (in range)
  \ifnum\inrange{Acinetobacter baumannii}=1
    Acinetobacter baumannii & \XAOf{Acinetobacter baumannii} & \XATagOf{Acinetobacter baumannii} \\
    \arrayrulecolor{lighterbar}\specialrule{0.7pt}{0pt}{0pt}\arrayrulecolor{black}
  \fi
  
  \ifnum\inrange{Citrobacter freundii}=1
    Citrobacter freundii & \XAOf{Citrobacter freundii} & \XATagOf{Citrobacter freundii} \\
    \arrayrulecolor{lighterbar}\specialrule{0.7pt}{0pt}{0pt}\arrayrulecolor{black}
  \fi
  
  \ifnum\inrange{Enterococcus faecalis}=1
    Enterococcus faecalis & \XAOf{Enterococcus faecalis} & \XATagOf{Enterococcus faecalis} \\
    \arrayrulecolor{lighterbar}\specialrule{0.7pt}{0pt}{0pt}\arrayrulecolor{black}
  \fi
  
  \ifnum\inrange{Enterococcus faecium}=1
    Enterococcus faecium & \XAOf{Enterococcus faecium} & \XATagOf{Enterococcus faecium} \\
    \arrayrulecolor{lighterbar}\specialrule{0.7pt}{0pt}{0pt}\arrayrulecolor{black}
  \fi
  
  \ifnum\inrange{Enterobacter cloacae}=1
    Enterobacter cloacae & \XAOf{Enterobacter cloacae} & \XATagOf{Enterobacter cloacae} \\
    \arrayrulecolor{lighterbar}\specialrule{0.7pt}{0pt}{0pt}\arrayrulecolor{black}
  \fi
  
  \ifnum\inrange{Enterobacter aerogenes}=1
    Enterobacter aerogenes & \XAOf{Enterobacter aerogenes} & \XATagOf{Enterobacter aerogenes} \\
    \arrayrulecolor{lighterbar}\specialrule{0.7pt}{0pt}{0pt}\arrayrulecolor{black}
  \fi
  
  \ifnum\inrange{Escherichia coli}=1
    Escherichia coli & \XAOf{Escherichia coli} & \XATagOf{Escherichia coli} \\
    \arrayrulecolor{lighterbar}\specialrule{0.7pt}{0pt}{0pt}\arrayrulecolor{black}
  \fi
  
  \ifnum\inrange{Klebsiella pneumoniae}=1
    Klebsiella pneumoniae & \XAOf{Klebsiella pneumoniae} & \XATagOf{Klebsiella pneumoniae} \\
    \arrayrulecolor{lighterbar}\specialrule{0.7pt}{0pt}{0pt}\arrayrulecolor{black}
  \fi
  
  \ifnum\inrange{Proteus mirabilis}=1
    Proteus mirabilis & \XAOf{Proteus mirabilis} & \XATagOf{Proteus mirabilis} \\
    \arrayrulecolor{lighterbar}\specialrule{0.7pt}{0pt}{0pt}\arrayrulecolor{black}
  \fi
  
  \ifnum\inrange{Proteus vulgaris}=1
    Proteus vulgaris & \XAOf{Proteus vulgaris} & \XATagOf{Proteus vulgaris} \\
    \arrayrulecolor{lighterbar}\specialrule{0.7pt}{0pt}{0pt}\arrayrulecolor{black}
  \fi
  
  \ifnum\inrange{Pseudomonas aeruginosa}=1
    Pseudomonas aeruginosa & \XAOf{Pseudomonas aeruginosa} & \XATagOf{Pseudomonas aeruginosa} \\
    \arrayrulecolor{lighterbar}\specialrule{0.7pt}{0pt}{0pt}\arrayrulecolor{black}
  \fi
  
  \ifnum\inrange{Staphylococcus aureus}=1
    Staphylococcus aureus & \XAOf{Staphylococcus aureus} & \XATagOf{Staphylococcus aureus} \\
    \arrayrulecolor{lighterbar}\specialrule{0.7pt}{0pt}{0pt}\arrayrulecolor{black}
  \fi
  
  \ifnum\inrange{Staphylococcus saprophyticus}=1
    Staphylococcus saprophyticus & \XAOf{Staphylococcus saprophyticus} & \XATagOf{Staphylococcus saprophyticus} \\
    \arrayrulecolor{lighterbar}\specialrule{0.7pt}{0pt}{0pt}\arrayrulecolor{black}
  \fi
  
  \ifnum\inrange{Strep B/ S. agalactiae}=1
    Strep B/ S. agalactiae & \XAOf{Strep B/ S. agalactiae} & \XATagOf{Strep B/ S. agalactiae} \\
    \arrayrulecolor{lighterbar}\specialrule{0.7pt}{0pt}{0pt}\arrayrulecolor{black}
  \fi
  
  \ifnum\inrange{Ureaplasma urealyticum}=1
    Ureaplasma urealyticum & \XAOf{Ureaplasma urealyticum} & \XATagOf{Ureaplasma urealyticum} \\
    \arrayrulecolor{lighterbar}\specialrule{0.7pt}{0pt}{0pt}\arrayrulecolor{black}
  \fi
  
  \ifnum\inrange{Candida albicans}=1
    Candida albicans & \XAOf{Candida albicans} & \XATagOf{Candida albicans} \\
    \arrayrulecolor{lighterbar}\specialrule{0.7pt}{0pt}{0pt}\arrayrulecolor{black}
  \fi
  
  \ifnum\inrange{Candida auris}=1
    Candida auris & \XAOf{Candida auris} & \XATagOf{Candida auris} \\
    \arrayrulecolor{lighterbar}\specialrule{0.7pt}{0pt}{0pt}\arrayrulecolor{black}
  \fi
  
  \ifnum\inrange{Candida glabrata}=1
    Candida glabrata & \XAOf{Candida glabrata} & \XATagOf{Candida glabrata} \\
  \fi
\fi
...
\fbox{%
  \parbox{\dimexpr\textwidth-2\fboxsep\relax}{% keep box exactly \textwidth
    ...
    \begin{minipage}[t]{\textwidth}
      ...
      \noindent\hspace*{17em}\begin{tabular*}{\linewidth}{ccc}
...
\begin{tabularx}{\textwidth}{>{\itshape}p{5.7cm} p{5.7cm} c >{\centering\arraybackslash\itshape}m{2cm} >{\itshape\scriptsize}X}
...
Acinetobacter baumannii & \ResultOf{Acinetobacter baumannii} & \XAOf{Acinetobacter baumannii} & \XATagOf{Acinetobacter baumannii} & \DescOf{Acinetobacter baumannii} \\
\arrayrulecolor{lighterbar}\specialrule{0.7pt}{0pt}{0pt}\arrayrulecolor{black}

Citrobacter freundii & \ResultOf{Citrobacter freundii} & \XAOf{Citrobacter freundii} & \XATagOf{Citrobacter freundii} & \DescOf{Citrobacter freundii} \\
\arrayrulecolor{lighterbar}\specialrule{0.7pt}{0pt}{0pt}\arrayrulecolor{black}

Enterococcus faecalis  & \ResultOf{Enterococcus faecalis}  & \XAOf{Enterococcus faecalis}  & \XATagOf{Enterococcus faecalis}  & \DescOf{Enterococcus faecalis} \\
\arrayrulecolor{lighterbar}\specialrule{0.7pt}{0pt}{0pt}\arrayrulecolor{black}

Enterococcus faecium & \ResultOf{Enterococcus faecium} & \XAOf{Enterococcus faecium} & \XATagOf{Enterococcus faecium} & \DescOf{Enterococcus faecium} \\
\arrayrulecolor{lighterbar}\specialrule{0.7pt}{0pt}{0pt}\arrayrulecolor{black}

Enterobacter cloacae & \ResultOf{Enterobacter cloacae} & \XAOf{Enterobacter cloacae} & \XATagOf{Enterobacter cloacae} & \DescOf{Enterobacter cloacae} \\
\arrayrulecolor{lighterbar}\specialrule{0.7pt}{0pt}{0pt}\arrayrulecolor{black}

Enterobacter aerogenes & \ResultOf{Enterobacter aerogenes} & \XAOf{Enterobacter aerogenes} & \XATagOf{Enterobacter aerogenes} & \DescOf{Enterobacter aerogenes} \\
\arrayrulecolor{lighterbar}\specialrule{0.7pt}{0pt}{0pt}\arrayrulecolor{black}

Escherichia coli & \ResultOf{Escherichia coli} & \XAOf{Escherichia coli} & \XATagOf{Escherichia coli} & \DescOf{Escherichia coli} \\
\arrayrulecolor{lighterbar}\specialrule{0.7pt}{0pt}{0pt}\arrayrulecolor{black}

Klebsiella pneumoniae & \ResultOf{Klebsiella pneumoniae} & \XAOf{Klebsiella pneumoniae} & \XATagOf{Klebsiella pneumoniae} & \DescOf{Klebsiella pneumoniae} \\
\arrayrulecolor{lighterbar}\specialrule{0.7pt}{0pt}{0pt}\arrayrulecolor{black}

Proteus mirabilis & \ResultOf{Proteus mirabilis} & \XAOf{Proteus mirabilis} & \XATagOf{Proteus mirabilis} & \DescOf{Proteus mirabilis} \\
\arrayrulecolor{lighterbar}\specialrule{0.7pt}{0pt}{0pt}\arrayrulecolor{black}

Proteus vulgaris & \ResultOf{Proteus vulgaris} & \XAOf{Proteus vulgaris} & \XATagOf{Proteus vulgaris} & \DescOf{Proteus vulgaris} \\
\arrayrulecolor{lighterbar}\specialrule{0.7pt}{0pt}{0pt}\arrayrulecolor{black}

Pseudomonas aeruginosa & \ResultOf{Pseudomonas aeruginosa} & \XAOf{Pseudomonas aeruginosa} & \XATagOf{Pseudomonas aeruginosa} & \DescOf{Pseudomonas aeruginosa} \\
\arrayrulecolor{lighterbar}\specialrule{0.7pt}{0pt}{0pt}\arrayrulecolor{black}

Staphylococcus aureus & \ResultOf{Staphylococcus aureus} & \XAOf{Staphylococcus aureus} & \XATagOf{Staphylococcus aureus} & \DescOf{Staphylococcus aureus} \\
\arrayrulecolor{lighterbar}\specialrule{0.7pt}{0pt}{0pt}\arrayrulecolor{black}

Staphylococcus saprophyticus & \ResultOf{Staphylococcus saprophyticus} & \XAOf{Staphylococcus saprophyticus} & \XATagOf{Staphylococcus saprophyticus} & \DescOf{Staphylococcus saprophyticus} \\
\arrayrulecolor{lighterbar}\specialrule{0.7pt}{0pt}{0pt}\arrayrulecolor{black}

Strep B/ S. agalactiae & \ResultOf{Strep B/ S. agalactiae} & \XAOf{Strep B/ S. agalactiae} & \XATagOf{Strep B/ S. agalactiae} & \DescOf{Strep B/ S. agalactiae} \\
\arrayrulecolor{lighterbar}\specialrule{0.7pt}{0pt}{0pt}\arrayrulecolor{black}

Ureaplasma urealyticum & \ResultOf{Ureaplasma urealyticum} & \XAOf{Ureaplasma urealyticum} & \XATagOf{Ureaplasma urealyticum} & \DescOf{Ureaplasma urealyticum} \\
...
Candida albicans   & \ResultOf{Candida albicans}   & \XAOf{Candida albicans}   & \XATagOf{Candida albicans}   & \DescOf{Candida albicans} \\
\arrayrulecolor{lighterbar}\specialrule{0.7pt}{0pt}{0pt}\arrayrulecolor{black}

Candida auris      & \ResultOf{Candida auris}      & \XAOf{Candida auris}      & \XATagOf{Candida auris}      & \DescOf{Candida auris} \\
\arrayrulecolor{lighterbar}\specialrule{0.7pt}{0pt}{0pt}\arrayrulecolor{black}

% Candida tropicalis & \ResultOf{Candida tropicalis} & \XAOf{Candida tropicalis} & \XATagOf{Candida tropicalis} & \DescOf{Candida tropicalis} \\
% \arrayrulecolor{lighterbar}\specialrule{0.7pt}{0pt}{0pt}\arrayrulecolor{black}

% Candida krusei     & \ResultOf{Candida krusei}     & \XAOf{Candida krusei}     & \XATagOf{Candida krusei}     & \DescOf{Candida krusei} \\
% \arrayrulecolor{lighterbar}\specialrule{0.7pt}{0pt}{0pt}\arrayrulecolor{black}

Candida glabrata   & \ResultOf{Candida glabrata}   & \XAOf{Candida glabrata}   & \XATagOf{Candida glabrata}   & \DescOf{Candida glabrata} \\
