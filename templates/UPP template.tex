...
% \begin{tabular}{\textwidth}{>{\itshape}p{5.7cm} c >{\itshape}c >{\itshape\scriptsize}X}
...
\ifdim\Val{Acinetobacter baumannii}pt>0pt \ifdim\Val{Acinetobacter baumannii}pt<35pt Acinetobacter baumannii & \XAOf{Acinetobacter baumannii} & \XATagOf{Acinetobacter baumannii} \\
\fi\fi

\ifdim\Val{Citrobacter freundii}pt>0pt \ifdim\Val{Citrobacter freundii}pt<35pt
Citrobacter freundii & \XAOf{Citrobacter freundii} & \XATagOf{Citrobacter freundii} \\
\arrayrulecolor{lighterbar}\specialrule{0.7pt}{0pt}{0pt}\arrayrulecolor{black}
\fi\fi

\ifdim\Val{Enterococcus faecalis}pt>0pt \ifdim\Val{Enterococcus faecalis}pt<35pt
Enterococcus faecalis & \XAOf{Enterococcus faecalis} & \XATagOf{Enterococcus faecalis} \\
\arrayrulecolor{lighterbar}\specialrule{0.7pt}{0pt}{0pt}\arrayrulecolor{black}
\fi\fi

\ifdim\Val{Enterococcus faecium}pt>0pt \ifdim\Val{Enterococcus faecium}pt<35pt
Enterococcus faecium & \XAOf{Enterococcus faecium} & \XATagOf{Enterococcus faecium} \\
\arrayrulecolor{lighterbar}\specialrule{0.7pt}{0pt}{0pt}\arrayrulecolor{black}
\fi\fi

\ifdim\Val{Enterobacter cloacae}pt>0pt \ifdim\Val{Enterobacter cloacae}pt<35pt
Enterobacter cloacae & \XAOf{Enterobacter cloacae} & \XATagOf{Enterobacter cloacae} \\
\arrayrulecolor{lighterbar}\specialrule{0.7pt}{0pt}{0pt}\arrayrulecolor{black}
\fi\fi

\ifdim\Val{Enterobacter aerogenes}pt>0pt \ifdim\Val{Enterobacter aerogenes}pt<35pt
Enterobacter aerogenes & \XAOf{Enterobacter aerogenes} & \XATagOf{Enterobacter aerogenes} \\
\arrayrulecolor{lighterbar}\specialrule{0.7pt}{0pt}{0pt}\arrayrulecolor{black}
\fi\fi

\ifdim\Val{Escherichia coli}pt>0pt \ifdim\Val{Escherichia coli}pt<35pt
Escherichia coli & \XAOf{Escherichia coli} & \XATagOf{Escherichia coli} \\
\arrayrulecolor{lighterbar}\specialrule{0.7pt}{0pt}{0pt}\arrayrulecolor{black}
\fi\fi

\ifdim\Val{Klebsiella pneumoniae}pt>0pt \ifdim\Val{Klebsiella pneumoniae}pt<35pt
Klebsiella pneumoniae & \XAOf{Klebsiella pneumoniae} & \XATagOf{Klebsiella pneumoniae} \\
\arrayrulecolor{lighterbar}\specialrule{0.7pt}{0pt}{0pt}\arrayrulecolor{black}
\fi\fi

\ifdim\Val{Proteus mirabilis}pt>0pt \ifdim\Val{Proteus mirabilis}pt<35pt
Proteus mirabilis & \XAOf{Proteus mirabilis} & \XATagOf{Proteus mirabilis} \\
\arrayrulecolor{lighterbar}\specialrule{0.7pt}{0pt}{0pt}\arrayrulecolor{black}
\fi\fi

\ifdim\Val{Proteus vulgaris}pt>0pt \ifdim\Val{Proteus vulgaris}pt<35pt
Proteus vulgaris & \XAOf{Proteus vulgaris} & \XATagOf{Proteus vulgaris} \\
\arrayrulecolor{lighterbar}\specialrule{0.7pt}{0pt}{0pt}\arrayrulecolor{black}
\fi\fi

\ifdim\Val{Pseudomonas aeruginosa}pt>0pt \ifdim\Val{Pseudomonas aeruginosa}pt<35pt
Pseudomonas aeruginosa & \XAOf{Pseudomonas aeruginosa} & \XATagOf{Pseudomonas aeruginosa} \\
\arrayrulecolor{lighterbar}\specialrule{0.7pt}{0pt}{0pt}\arrayrulecolor{black}
\fi\fi

\ifdim\Val{Staphylococcus aureus}pt>0pt \ifdim\Val{Staphylococcus aureus}pt<35pt
Staphylococcus aureus & \XAOf{Staphylococcus aureus} & \XATagOf{Staphylococcus aureus} \\
\arrayrulecolor{lighterbar}\specialrule{0.7pt}{0pt}{0pt}\arrayrulecolor{black}
\fi\fi

\ifdim\Val{Staphylococcus saprophyticus}pt>0pt \ifdim\Val{Staphylococcus saprophyticus}pt<35pt
Staphylococcus saprophyticus & \XAOf{Staphylococcus saprophyticus} & \XATagOf{Staphylococcus saprophyticus} \\
\arrayrulecolor{lighterbar}\specialrule{0.7pt}{0pt}{0pt}\arrayrulecolor{black}
\fi\fi

\ifdim\Val{Strep B/ S. agalactiae}pt>0pt \ifdim\Val{Strep B/ S. agalactiae}pt<35pt
Strep B/ S. agalactiae & \XAOf{Strep B/ S. agalactiae} & \XATagOf{Strep B/ S. agalactiae} \\
\arrayrulecolor{lighterbar}\specialrule{0.7pt}{0pt}{0pt}\arrayrulecolor{black}
\fi\fi

\ifdim\Val{Ureaplasma urealyticum}pt>0pt \ifdim\Val{Ureaplasma urealyticum}pt<35pt
Ureaplasma urealyticum & \XAOf{Ureaplasma urealyticum} & \XATagOf{Ureaplasma urealyticum} \\
\arrayrulecolor{lighterbar}\specialrule{0.7pt}{0pt}{0pt}\arrayrulecolor{black}
\fi\fi

\ifdim\Val{Candida albicans}pt>0pt \ifdim\Val{Candida albicans}pt<35pt
Candida albicans & \XAOf{Candida albicans} & \XATagOf{Candida albicans} \\
\arrayrulecolor{lighterbar}\specialrule{0.7pt}{0pt}{0pt}\arrayrulecolor{black}
\fi\fi

\ifdim\Val{Candida auris}pt>0pt \ifdim\Val{Candida auris}pt<35pt
Candida auris & \XAOf{Candida auris} & \XATagOf{Candida auris} \\
\arrayrulecolor{lighterbar}\specialrule{0.7pt}{0pt}{0pt}\arrayrulecolor{black}
\fi\fi

\ifdim\Val{Candida glabrata}pt>0pt \ifdim\Val{Candida glabrata}pt<35pt
...
\textbf{Methods:} 
{\small This specimen was analyzed by real-time PCR method developed by Thermo Fisher Scientific. The assay was validated by X-Gene Laboratory following the CLIA standards.} 
...
\begin{tabularx}{\textwidth}{>{\itshape}p{5.7cm} p{5.7cm} c >{\itshape}c >{\itshape\scriptsize}X}
