...
\fancypagestyle{mainpagestyle}{
    ...
    \fancyfoot[L]{\texttt{\small CRV-RP-2508}}
...
\begin{tabularx}{\textwidth}{@{}%
    ...
    \begin{minipage}{\linewidth}
        ...
        % {\fontsize{16}{22}\selectfont Pregnancy Pathogen Panel}
        {\fontsize{16}{22}\selectfont CRV \large{(Common Respiratory Virus)} \fontsize{16}{22}\selectfont Test}
    \end{minipage}
    &
...
% ---------  Virus -----------
\rowcolor{gray!10}\multicolumn{5}{l}{\textbf{Virus }} \\
\hline

% COVID-19 & \ResultOf{Covid-19} & \XAOf{Covid-19} & \XATagOf{Covid-19} & \paddedbox{\DescOf{Covid-19}} \\
COVID-19 & \ResultOf{Covid-19} &  &  & \\
\arrayrulecolor{lighterbar}\specialrule{0.7pt}{0pt}{0pt}\arrayrulecolor{black}

% Influenza A/B & \ResultOf{Flu} & \XAOf{Flu} & \XATagOf{Flu} & \paddedbox{\DescOf{Flu}} \\
Influenza A/B & \ResultOf{Flu} &  &  & \\
\arrayrulecolor{lighterbar}\specialrule{0.7pt}{0pt}{0pt}\arrayrulecolor{black}

\paddedbox{RSV \footnotesize{(Respiratory syncytial virus)}}
% & \ResultOf{RSV} & \XAOf{RSV} & \XATagOf{RSV} & \paddedbox{\DescOf{RSV}} \\
& \ResultOf{RSV} &  &  &  \\
\arrayrulecolor{lighterbar}\specialrule{0.7pt}{0pt}{0pt}\arrayrulecolor{black}
