...
% \begin{longtable}{>{\itshape}p{7cm} p{2.4cm} c >{\itshape}c >{\itshape\scriptsize}p{1cm}}

\begin{longtable}{
  >{\itshape}p{8.5cm}                         % 1st
  p{3.5cm}                                  % 2nd
  >{\centering\arraybackslash}p{1.7cm}      % 3rd — wider
  >{\itshape\centering\arraybackslash}p{2.5cm} % 4th — wider, italic
  >{\itshape\scriptsize}p{1cm}              % 5th
}
...
Herpes Virus 1 & \ResultOf{Herpes Virus 1} & \XAOf{Herpes Virus 1} & \XATagOf{Herpes Virus 1} & \paddedbox{\DescOf{Herpes Virus 1}} \\
\arrayrulecolor{lighterbar}\specialrule{0.7pt}{0pt}{0pt}\arrayrulecolor{black}

Herpes Virus 2 & \ResultOf{Herpes Virus 2} & \XAOf{Herpes Virus 2} & \XATagOf{Herpes Virus 2} & \paddedbox{\DescOf{Herpes Virus 2}} \\
