...
\fancypagestyle{mainpagestyle}{
    ...
    \fancyfoot[L]{\texttt{\small ABR-RP-2601}}
...
\small{This assay tests a group of selected markers for each drug class. The positive result indicate a pathogen carrying antibiotics resistance gene and may have resistance to correspondent antibiotics. However, the "Not Detected" result indicate the listed markers are not detected by this test, or the amount of these markers is below the detection limit.  The "Not Detected" results does not exclude other markers that not listed in this panel.}

% \vspace{10pt}

\noindent
\normalsize{\textbf{Disclaimer:}}
\small{The test was developed and characterized by X-Gene diagnostics. The test in this Antibiotics Resistance panel have not been approved by the Federal Drug Administration. The FDA has determined that such approval is not necessary, provided that the laboratory both (1) maintains its good standing as a clinical testing laboratory with all mandatory accrediting bodies, and (2) continually demonstrates that its testing protocols and procedures achieve a high degree of analytical accuracy.}
