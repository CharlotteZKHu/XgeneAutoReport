...
% ---- Result: IF(H="X","Not tested", IF(OR(H=0,H="",H>35),"Not detected", IF(0<H<=35,"Detected","")))
...
% ---- Pathogen level: IF(OR(H=0,H>=35),"",35-H)
...
%           { }
%           {
%             % Your existing fp_compare logic here
%           }
%       }
%   }
...
\NewDocumentCommand{\ResultPretty}{m}
 {
   ...
   \tl_if_blank:nTF {#1}{\ResultIndent Not~detected}{
     \str_if_eq:nnTF {#1}{X}{\ResultIndent Not~tested}{
       \fp_set:Nn \l_tmpa_fp {#1}
       \fp_compare:nTF { \l_tmpa_fp > 0 }{
         % \fp_compare:nTF { \l_tmpa_fp <= 35 }
         \fp_compare:nTF { \l_tmpa_fp < 35 }
...
% STIs
% \DescSet{Neisseria gonorrhoeae}{May cause Pelvic inflammatory disease} 
\DescSet{Neisseria gonorrhoeae}{May cause PID} 
\DescSet{Chlamydia trachomatis}{May cause PID}
\DescSet{Trichomonas vaginalis}{}
\DescSet{Mycoplasma hominis}{May cause PID}
\DescSet{Mycoplasma genitalium}{May cause PID}
\DescSet{Haemophilus ducreyi}{}
\DescSet{Treponema pallidum}{Causes syphilis}

% Bacteria
\DescSet{Atopobium vaginae}{May cause preterm delivery or PID}
\DescSet{BVAB2}{May play a role in BV recurrence}
\DescSet{Enterococcus faecalis}{Cause aerobic vaginitis}
\DescSet{Gardnerella vaginalis}{Increase the risk of PID or UTI}
\DescSet{Megasphaera 1}{Key indicator of BV*}
\DescSet{Megasphaera 2}{Key indicator of BV*}
\DescSet{Mobiluncus mulieris}{Key indicator of BV*}
\DescSet{Prevotella bivia}{Cause recurrence of BV}
\DescSet{Strep B/ S. agalactiae}{Cause aerobic vaginitis}
\DescSet{Ureaplasma urealyticum}{Cause aerobic vaginitis}
...
\ValSet{Barcode}{100001}
\ValSet{TestID}{XG-999111}
\ValSet{DateCollected}{10/5/2025}
\ValSet{DateReceived}{10/06/2025}
\ValSet{ReportDate}{11/15/2025}
\ValSet{Candida albicans}{0}
\ValSet{Candida glabrata}{0}
\ValSet{Lactobacillus}{17.7}
\ValSet{Mycoplasma genitalium}{27.3}
\ValSet{Megasphaera 1}{0}
\ValSet{HSV-2}{0}
\ValSet{BVAB2}{0}
\ValSet{Atopobium vaginae}{32.6}
\ValSet{Chlamydia trachomatis}{37.4}
\ValSet{Mobiluncus mulieris}{0}
\ValSet{Gardnerella vaginalis}{31.5}
\ValSet{Ureaplasma urealyticum}{31.7}
\ValSet{Strep B/ S. agalactiae}{0.0}
\ValSet{Prevotella bivia}{0}
\ValSet{Neisseria gonorrhoeae}{0}
\ValSet{Candida krusei}{0}
\ValSet{Trichomonas vaginalis}{0}
\ValSet{Mycoplasma hominis}{0}
\ValSet{Enterococcus faecalis}{38.4}
\ValSet{Sample integrity control}{21.1}
\ValSet{HSV-1}{20}
\ValSet{Megasphaera 2}{17.2}
\ValSet{Candida auris}{0}
\ValSet{Candida tropicalis}{0}
\ValSet{Haemophilus ducreyi}{0}
\ValSet{Treponema pallidum}{0}
\ValSet{Unnamed: 31}{0}
\ValSet{Unnamed: 32}{0}
\ValSet{Unnamed: 33}{0}
\ValSet{Unnamed: 34}{0}
...
\ValSet{Unnamed: 47}{0}
\ValSet{Unnamed: 48}{0}
\ValSet{PatientFirstName}{Jane}
\ValSet{PatientLastName}{Doe}
\ValSet{PatientDOB}{10/13/1985}
\ValSet{PatientSex}{Female}
\ValSet{PhysicianName}{Dr. Susan Ray}
\ValSet{PhysicianSpecialty}{Obstetrics \& Gynecology}

% You can also do blanks or X:
% \ValSet{HSV-1}{}
% \ValSet{HSV-2}{X}
...
\newcommand{\getTestControlStatus}[1]{%
    \ifthenelse{\equal{\Val{#1}}{X}}{% If the value is "X", output nothing.
    }{%
        % Otherwise, run the original numerical check.
        \ifdim\Val{#1}pt>0pt
            Sample quality pass%
        \else
...
\newcommand{\isDetected}[1]{%
    \ifthenelse{\equal{\Val{#1}}{X}}{0}{% <-- ADD THIS: If value is 'X', return 0
        \ifthenelse{\equal{\Val{#1}}{}}{0}{% <-- Also good to handle blanks
            \ifthenelse{\lengthtest{\Val{#1} pt > 0 pt} \AND \lengthtest{\Val{#1} pt < 35.01 pt}}{1}{0}%
        }%
    }%
}
...
% \newcommand{\getPathogenLevel}[1]{%
%     \ifthenelse{\equal{\Val{#1}}{X}}{None}{% <-- ADD THIS: If value is 'X', return None
%         \ifthenelse{\equal{\Val{#1}}{}}{None}{% <-- Also good to handle blanks
%             \ifdim\Val{#1}pt>0pt
%                 \ifdim\Val{#1}pt<25.01pt
%                     High%
%                 \else
...
\newcommand{\checkSTIs}{%
    ...
    \ifdim\Val{HSV1}pt>0pt true\else%
    \ifdim\Val{HSV2}pt>0pt true\else%
...
\begin{tabularx}{\textwidth}{@{}%
    ...
    \includegraphics[height=0.4in]{../assets/CAP_icon.png}
    &
...
\begin{minipage}[t]{\linewidth}
  ...
  \begin{tabular}{@{}l l@{}}
    ...
    \textbf{Sample Type:}    & Vaginal Swab \\[4pt]
...
Neisseria gonorrhoeae  & \ResultOf{Neisseria gonorrhoeae}  & \XAOf{Neisseria gonorrhoeae}  & \XATagOf{Neisseria gonorrhoeae}  & \DescOf{Neisseria gonorrhoeae} \\
\arrayrulecolor{lighterbar}\specialrule{1pt}{0pt}{0pt}\arrayrulecolor{black}

Chlamydia trachomatis  & \ResultOf{Chlamydia trachomatis}  & \XAOf{Chlamydia trachomatis}  & \XATagOf{Chlamydia trachomatis}  & \DescOf{Chlamydia trachomatis} \\
\arrayrulecolor{lighterbar}\specialrule{1pt}{0pt}{0pt}\arrayrulecolor{black}
...
Mycoplasma hominis     & \ResultOf{Mycoplasma hominis}     & \XAOf{Mycoplasma hominis}     & \XATagOf{Mycoplasma hominis}     & \DescOf{Mycoplasma hominis} \\
\arrayrulecolor{lighterbar}\specialrule{1pt}{0pt}{0pt}\arrayrulecolor{black}

Mycoplasma genitalium  & \ResultOf{Mycoplasma genitalium}  & \XAOf{Mycoplasma genitalium}  & \XATagOf{Mycoplasma genitalium}  & \DescOf{Mycoplasma genitalium} \\
\arrayrulecolor{lighterbar}\specialrule{1pt}{0pt}{0pt}\arrayrulecolor{black}

Haemophilus ducreyi    & \ResultOf{Haemophilus ducreyi}    & \XAOf{Haemophilus ducreyi}    & \XATagOf{Haemophilus ducreyi}    & \DescOf{Haemophilus ducreyi} \\
\arrayrulecolor{lighterbar}\specialrule{1pt}{0pt}{0pt}\arrayrulecolor{black}

Treponema pallidum     & \ResultOf{Treponema pallidum}     & \XAOf{Treponema pallidum}     & \XATagOf{Treponema pallidum}     & \DescOf{Treponema pallidum} \\
...
\hline
Atopobium vaginae      & \ResultOf{Atopobium vaginae}      & \XAOf{Atopobium vaginae}      & \XATagOf{Atopobium vaginae}      & \DescOf{Atopobium vaginae} \\
\arrayrulecolor{lighterbar}\specialrule{1pt}{0pt}{0pt}\arrayrulecolor{black}

BVAB2                  & \ResultOf{BVAB2}                  & \XAOf{BVAB2}                  & \XATagOf{BVAB2}                  & \DescOf{BVAB2} \\
\arrayrulecolor{lighterbar}\specialrule{1pt}{0pt}{0pt}\arrayrulecolor{black}
...
Gardnerella vaginalis  & \ResultOf{Gardnerella vaginalis}  & \XAOf{Gardnerella vaginalis}  & \XATagOf{Gardnerella vaginalis}  & \DescOf{Gardnerella vaginalis} \\
\arrayrulecolor{lighterbar}\specialrule{1pt}{0pt}{0pt}\arrayrulecolor{black}

Megasphaera 1          & \ResultOf{Megasphaera 1}          & \XAOf{Megasphaera 1}          & \XATagOf{Megasphaera 1}          & \DescOf{Megasphaera 1} \\
\arrayrulecolor{lighterbar}\specialrule{1pt}{0pt}{0pt}\arrayrulecolor{black}

Megasphaera 2          & \ResultOf{Megasphaera 2}          & \XAOf{Megasphaera 2}          & \XATagOf{Megasphaera 2}          & \DescOf{Megasphaera 2} \\
\arrayrulecolor{lighterbar}\specialrule{1pt}{0pt}{0pt}\arrayrulecolor{black}

Mobiluncus mulieris    & \ResultOf{Mobiluncus mulieris}    & \XAOf{Mobiluncus mulieris}    & \XATagOf{Mobiluncus mulieris}    & \DescOf{Mobiluncus mulieris} \\
\arrayrulecolor{lighterbar}\specialrule{1pt}{0pt}{0pt}\arrayrulecolor{black}

Prevotella bivia       & \ResultOf{Prevotella bivia}       & \XAOf{Prevotella bivia}       & \XATagOf{Prevotella bivia}       & \DescOf{Prevotella bivia} \\
\arrayrulecolor{lighterbar}\specialrule{1pt}{0pt}{0pt}\arrayrulecolor{black}
...
HSV-1 & \ResultOf{HSV-1} & \XAOf{HSV-1} & \XATagOf{HSV-1} & \DescOf{HSV-1} \\
\arrayrulecolor{lighterbar}\specialrule{1pt}{0pt}{0pt}\arrayrulecolor{black}

HSV-2 & \ResultOf{HSV-2} & \XAOf{HSV-2} & \XATagOf{HSV-2} & \DescOf{HSV-2} \\
